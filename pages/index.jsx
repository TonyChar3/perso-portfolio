  ...
  return (
    <>
      ...
      >
        ...
        <RevealAnimation className="w-full h-[50%] p-3 flex flex-col justify-center md:items-center lg:relative">
          <div className="flex flex-col w-[100%] md:w-[65%] lg:w-[40%] lg:absolute lg:left-[15%] lg:top-[5%] text-[#36456F]">
            <motion.h2
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              className="text-5xl lg:text-6xl my-8 font-bold"
            >
              Welcome to my website.
            </motion.h2>
            <p className="w-[86%] text-2xl lg:text-4xl lg:w-[84%] font-light">
              Hi, my name is Anthony Charette. I am a full-stack developer &
              designer.
            </p>
          </div>
        </RevealAnimation>
        ...
        <Image
          priority
          src="https://ik.imagekit.io/bqofr3ncj/tr:w-400/Portfolio/DALL_E_2024-01-02_22.18.35_-_A_classical_white_marble_bust_sculpture_of_a_mythical_figure_with_curly_hair_and_a_missing_nose_piece__resembling_ancient_Greek_or_Roman_art__on_a_pla-removebg-preview.png?updatedAt=1704252024319"
          alt="desktop greek statue head"
          width="600"
          height="600"
          className="hidden lg:block lg:absolute lg:bottom-[10%] lg:right-[7%]"
        />
        ...
        <div className="w-full flex flex-row justify-center items-center lg:justify-end">
          <Image
            priority
            src="https://ik.imagekit.io/bqofr3ncj/tr:w-400/Portfolio/DALL_E_2024-01-02_22.18.35_-_A_classical_white_marble_bust_sculpture_of_a_mythical_figure_with_curly_hair_and_a_missing_nose_piece__resembling_ancient_Greek_or_Roman_art__on_a_pla-removebg-preview.png?updatedAt=1704252024319"
            alt="greek statue head"
            width="275"
            height="291"
            className="lg:hidden mx-5 md:w-[400px]"
          />
        ...
        <RevealAnimation className="hidden lg:flex lg:absolute top-[58%] left-[-10%] flex-col justify-around items-center w-[26%]">
          <Link href="https://twitter.com/tonyc6731" target="_blank">
            <i
              aria-hidden
              className="fa-brands fa-x-twitter text-5xl text-[#36456F] active:scale-[0.90] hover:scale-[1.05] transform-all ease duration-100"
            ></i>
          </Link>
          ...
          >
            <i
              aria-hidden
              className="fa-brands fa-linkedin text-5xl text-[#36456F] active:scale-[0.90] hover:scale-[1.05] transform-all ease duration-100"
            ></i>
          </Link>
          <div className="bg-[#36456F] w-[2.5px] h-[35px] mx-2 rounded-lg transform rotate-[90deg]"></div>
          {/* Divider line */}
          <Link href="https://github.com/TonyChar3" target="_blank">
            <i
              aria-hidden
              className="fa-brands fa-github text-5xl text-[#36456F] active:scale-[0.90] hover:scale-[1.05] transform-all ease duration-100"
            ></i>
          </Link>
        </RevealAnimation>
        ...
        <div className="hidden h-[7%] lg:block absolute bottom-0 p-2">
          <span className="text-xl font-light animate-pulse text-[#36456F]">
      ...
      >
        <RevealAnimation className="w-full h-[100%] lg:h-[90%] p-6 flex flex-col items-center lg:flex-row lg:justify-between">
          <div className="text-center md:w-[80%] lg:order-2 lg:w-[40%] lg:mx-6">
            <h2 className="text-3xl font-bold lg:text-5xl lg:p-3">
              - Who am I ? -
            </h2>
            ...
            <div className="text-center font-light text-xl lg:text-left md:text-2xl lg:text-3xl">
              ...
              <div className="my-4 lg:my-6">
                With a passion for coding and problem-solving, I thrive on
                creating innovative web solutions that bridge the gap between
          ...
          <div className="relative w-full h-full flex flex-row justify-center items-center lg:order-1 lg:w-[50%]">
            ...
            <div className="absolute top-[8%] left-[18%] lg:top-[20%] lg:left-[28%] flex justify-center items-center p-3 rounded-2xl bg-white shadow-[#00000066] shadow-xl w-[24%] h-[35%] md:w-[22%] md:h-[22%] md:flex md:justify-center md:items-center animate-pulsate-fwd">
              <i
                aria-hidden
                className="fa-brands fa-node-js text-6xl md:text-8xl"
              ></i>
            </div>
            {/* Python logo */}
            <div className="absolute top-[12%] right-[20%] lg:right-[8%] flex justify-center items-center p-3 rounded-2xl bg-white shadow-[#00000066] shadow-xl w-[24%] h-[35%] md:w-[22%] md:h-[22%] md:flex md:justify-center md:items-center animate-pulsate-fwd">
              <i
                aria-hidden
                className="fa-brands fa-python text-6xl md:text-8xl"
              ></i>
            </div>
            {/* Css logo */}
            <div className="absolute left-[3%] bottom-[5%] md:bottom-[28%] md:left-[5%] lg:left-[2%] lg:bottom-[25%] flex justify-center items-center p-3 rounded-2xl bg-white shadow-[#00000066] shadow-xl w-[24%] h-[35%] md:w-[22%] md:h-[22%] animate-pulsate-fwd">
              <i
                aria-hidden
                className="fa-brands fa-css3-alt text-6xl md:text-8xl"
              ></i>
            </div>
            {/* Javascript logo */}
            <div className="absolute bottom-[-8%] md:bottom-[3%] lg:bottom-[3%] flex justify-center items-center p-3 rounded-2xl bg-white shadow-[#00000066] shadow-xl w-[24%] h-[35%] md:w-[22%] md:h-[22%] md:flex md:justify-center md:items-center animate-pulsate-fwd">
              <i
                aria-hidden
                className="fa-brands fa-js text-6xl md:text-8xl"
              ></i>
            </div>
            {/* React logo */}
            <div className="absolute right-[1%] bottom-[8%] md:bottom-[20%] md:right-[8%] lg:bottom-[25%] lg:right-[3%] flex justify-center items-center p-3 rounded-2xl bg-white shadow-[#00000066] shadow-xl w-[24%] h-[35%] md:w-[22%] md:h-[22%] md:flex md:justify-center md:items-center animate-pulsate-fwd">
              <i
                aria-hidden
                className="fa-brands fa-react text-6xl md:text-8xl"
              ></i>
            </div>
          </div>
        </RevealAnimation>
          ...
          <div className="h-full w-full lg:w-[100%] flex flex-col md:flex-row md:flex-wrap lg:p-6 justify-around items-center gap-8">
            <RevealAnimation className="w-[40%] h-[25%] md:w-[42%] md:h-[33%] lg:w-[25%] lg:h-[80%] flex justify-center items-end shadow-[#00000066] shadow-2xl rounded-3xl active:scale-[0.90] transform-all ease duration-300 animate-pulsate-fwd lg:animate-none">
              <div className="w-[90%] h-[80%] md:h-[70%] flex flex-col justify-between items-center">
                <i
                  aria-hidden
                  className="fa-sharp fa-light fa-pen-nib text-7xl md:text-8xl lg:text-9xl"
                ></i>
                <div className="w-full text-center">
                  <p className="text-xl md:text-4xl md:p-2 lg:p-1 font-regular">
                    web design
                  </p>
            ...
            <RevealAnimation className="w-[40%] h-[25%] md:w-[42%] md:h-[33%] lg:w-[25%] lg:h-[80%] flex justify-center items-end shadow-[#00000066] shadow-2xl rounded-3xl active:scale-[0.90] transform-all ease duration-300 animate-pulsate-fwd lg:animate-none">
              <div className="w-[90%] h-[80%] md:h-[70%] flex flex-col justify-between items-center">
                <i
                  aria-hidden
                  className="fa-regular fa-gear-complex-code text-7xl md:text-8xl lg:text-9xl"
                ></i>
                <div className="w-full text-center">
                  <p className="text-xl md:text-4xl md:p-2 lg:p-1 font-regular">
                    development
            ...
            <RevealAnimation className="w-[40%] h-[25%] md:w-[42%] md:h-[33%] lg:w-[25%] lg:h-[80%] flex justify-center items-end shadow-[#00000066] shadow-2xl rounded-3xl active:scale-[0.90] transform-all ease duration-300 animate-pulsate-fwd lg:animate-none">
              <div className="w-[90%] h-[80%] md:h-[70%] flex flex-col justify-between items-center">
                <i
                  aria-hidden
                  className="fa-regular fa-list-check text-7xl md:text-8xl lg:text-9xl"
                ></i>
                <div className="w-full text-center">
                  <p className="text-xl md:text-4xl md:p-2 lg:p-1 font-regular">
                    management
      ...
      <footer className="relative h-[60%] w-full flex flex-col items-center justify-center bg-[#36456F] text-white">
        <svg
          className="hidden lg:block absolute left-[-1%] bottom-0"
        ...
        >
          <path
            d="M470 483C470 234.504 229.458 1.00003 0 1.00003"
            stroke="white"
            strokeWidth="2"
          />
        </svg>
        <RevealAnimation className="w-full h-full flex flex-col items-center">
          <div className="relative w-full h-[80%] flex flex-col justify-center items-center">
            <h3 className="text-4xl lg:text-6xl font-regular">
              - Let's work together -
            </h3>
            <Link
              href="/projects#contact-me"
              className="my-4 text-xl lg:text-2xl font-light z-[2]"
            >
              Get in touch →
            </Link>
