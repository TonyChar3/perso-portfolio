        ...
        <>
            ...
            ${open_mobile_nav? "-translate-x-0 z-[20]" : "-translate-x-[200%] lg:-translate-x-0"}`}>
                ...
                ${user_isScroll? "lg:bg-[#F9F9F9] lg:bg-opacity-[85%] rounded-full m-2" : ""}`}>
                    ...
                    md:mx-2
                    lg:mx-4 lg:flex lg:flex-row lg:justify-center lg:items-center
                    ${active_path === '/#about-me'? "lg:h-[20%] lg:py-5 p-2 text-center rounded-2xl bg-white shadow-[rgba(0, 0, 0, 0.25)] shadow-md relative" : "my-4 md:my-6 lg:my-4  lg:h-0"}`}>
                        <Link href="/#about-me" onClick={() => setMobileNav(open_mobile_nav => !open_mobile_nav)} className={`text-3xl font-light`}>About</Link>
                        <div className={`${active_path === '/#about-me'? "absolute top-[45%] right-[-20%] lg:top-[110%] lg:right-[50%] w-[10px] h-[10px] bg-[#36456F] rounded-full" : "hidden"}`}></div>
                    </div>
                    ...
                    md:mx-2
                    lg:mx-4 lg:flex lg:flex-row lg:justify-center lg:items-center
                    ${active_path === '/projects#project'? "lg:h-[20%] lg:py-5 p-2 text-center rounded-2xl bg-white shadow-[rgba(0, 0, 0, 0.25)] shadow-md relative" : "my-4 md:my-6 lg:my-4  lg:h-0"}`}>
                        <Link href="/projects#project" onClick={() => setMobileNav(open_mobile_nav => !open_mobile_nav)} className={`text-3xl font-light`}>Projects</Link>
                        <div className={`${active_path === '/projects#project'? "absolute top-[45%] right-[-20%] lg:top-[110%] lg:right-[50%] w-[10px] h-[10px] bg-[#36456F] rounded-full" : "hidden"}`}></div>
                    </div>
                    ...
                    md:mx-2
                    lg:mx-4 lg:flex lg:flex-row lg:justify-center lg:items-center
                    ${active_path === '/projects#contact-me'? "lg:h-[20%] lg:py-5 p-2 text-center rounded-2xl bg-white shadow-[rgba(0, 0, 0, 0.25)] shadow-md relative" : "my-4 md:my-6 lg:my-4  lg:h-0"}`}>
                        <Link href="/projects#contact-me" onClick={() => setMobileNav(open_mobile_nav => !open_mobile_nav)} className={`text-3xl font-light`}>Contact</Link>
