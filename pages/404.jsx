    ...
    return (
        <>
            <div className="relative w-full h-full flex flex-col justify-center items-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="471" height="483" viewBox="0 0 471 483" fill="none" className="hidden lg:block absolute top-[-11.5%] left-0">
                ...
                <div className="text-center flex flex-col jusitfy-center items-center">
                    <h2 className="text-3xl text-[#36456F] font-bold">ERROR 404 NOT FOUND</h2>
                    <Link href="/#welcome" className="bg-[#36456F] text-white p-3 my-6 rounded-xl text-xl active:scale-[0.90] transform-all ease duration-300">Return to safety</Link>
                </div>
